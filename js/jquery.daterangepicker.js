...
(function (factory) {
    ...
    $.dateRangePickerLanguages =
	{
	    ...
	    'es':
		{
		    ...
		    'default-range': 'Por favor seleciona un rango entre %d y %d dias',
	    ...
	    'pt':
		{
		    ...
		    'next-month': 'Mês',
		    'next-year': 'Ano',
		    'less-than': 'O PERIODO NÃO DEVE SER MAIOR que %d dias',
		    'more-than': 'O PERIODO NÃO DEVE SER MAIOR que %d dias',
		    'default-more': 'Por favor seleciona uma gama maior a %d dias',
		    'default-single': 'Por favor seleciona um dia',
		    'default-less': 'Por favor seleciona uma gama menor a %d dias',
		    'default-range': 'Por favor seleciona um periodo entre %d e %d dias',
		    'default-default': 'Por favor seleciona um periodo de datas.'
		},
	    'de':
		{
		    'selected': 'Auswahl:',
